from .dempy_pb2 import (
    ...
    AnnotationObject as AnnotationObjectMessage, AnnotationPoint as AnnotationPointMessage, Annotation as AnnotationMessage,
    SampleList as SampleListMessage, AnnotationList as AnnotationListMessage
)
